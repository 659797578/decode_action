//Mon Nov 11 2024 01:59:19 GMT+0000 (Coordinated Universal Time)
...
async function _0x4a407b(_0xb326d3, _0x2deb03) {
  return httpErr = null, httpReq = null, httpResp = null, new Promise(_0x2d11b1 => {
...
function _0x16e925(_0x1f9940, _0x1c147f) {
  return "undefined" != typeof process && JSON.stringify(process.env).indexOf("GITHUB") > -1 && process.exit(0), new class {
    ...
    ["setval"](_0x49a603, _0x31080a) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x49a603, _0x31080a) : this.isQuanX() ? $prefs.setValueForKey(_0x49a603, _0x31080a) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x31080a] = _0x49a603, this.writedata(), !0) : this.data && this.data[_0x31080a] || null;
    }
    ...
    ["padStr"](_0x4bae34, _0x477169, _0x5bcafd = "0") {
      ...
      return _0x3de83d += _0x2214d3, _0x3de83d;
    }
